...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 10, 2021 at 11:14 AM
...
(1, 'qwertyuiop', 1),
(2, '1808c6e115d2a3f0f181cbd374672bb72a8f41f5', 1);
...
('2021-08-15 07:39:46', 'ALTER TABLE `membership_groups` ADD UNIQUE INDEX `name` (`name`)', '0.00', 'Duplicate key name \'name\'', 'guest', '/citrus/app/index.php'),
('2021-08-15 07:39:46', 'ALTER TABLE `membership_groups` ADD COLUMN `allowCSVImport` TINYINT NOT NULL DEFAULT \'0\'', '0.00', 'Duplicate column name \'allowCSVImport\'', 'guest', '/citrus/app/index.php'),
('2021-08-15 07:39:46', 'ALTER TABLE `membership_users` ADD COLUMN `pass_reset_key` VARCHAR(100)', '0.00', 'Duplicate column name \'pass_reset_key\'', 'guest', '/citrus/app/index.php'),
('2021-08-15 07:39:46', 'ALTER TABLE `membership_users` ADD COLUMN `pass_reset_expiry` INT UNSIGNED', '0.00', 'Duplicate column name \'pass_reset_expiry\'', 'guest', '/citrus/app/index.php'),
('2021-08-15 07:39:46', 'ALTER TABLE `membership_users` ADD INDEX `groupID` (`groupID`)', '0.00', 'Duplicate key name \'groupID\'', 'guest', '/citrus/app/index.php'),
('2021-08-15 07:39:46', 'ALTER TABLE `membership_users` ADD COLUMN `flags` TEXT', '0.00', 'Duplicate column name \'flags\'', 'guest', '/citrus/app/index.php'),
('2021-08-15 07:39:46', 'ALTER TABLE `membership_users` ADD COLUMN `allowCSVImport` TINYINT NOT NULL DEFAULT \'0\'', '0.00', 'Duplicate column name \'allowCSVImport\'', 'guest', '/citrus/app/index.php'),
('2021-08-15 07:39:46', 'ALTER TABLE `membership_userrecords` ADD UNIQUE INDEX `tableName_pkValue` (`tableName`, `pkValue`(150))', '0.00', 'Duplicate key name \'tableName_pkValue\'', 'guest', '/citrus/app/index.php'),
('2021-08-15 07:39:46', 'ALTER TABLE `membership_userrecords` ADD INDEX `pkValue` (`pkValue`)', '0.00', 'Duplicate key name \'pkValue\'', 'guest', '/citrus/app/index.php'),
('2021-08-15 07:39:46', 'ALTER TABLE `membership_userrecords` ADD INDEX `tableName` (`tableName`)', '0.00', 'Duplicate key name \'tableName\'', 'guest', '/citrus/app/index.php'),
('2021-08-15 07:39:46', 'ALTER TABLE `membership_userrecords` ADD INDEX `memberID` (`memberID`)', '0.00', 'Duplicate key name \'memberID\'', 'guest', '/citrus/app/index.php'),
('2021-08-15 07:39:46', 'ALTER TABLE `membership_userrecords` ADD INDEX `groupID` (`groupID`)', '0.00', 'Duplicate key name \'groupID\'', 'guest', '/citrus/app/index.php'),
('2021-08-15 07:39:46', 'ALTER TABLE `membership_grouppermissions` ADD UNIQUE INDEX `groupID_tableName` (`groupID`, `tableName`)', '0.00', 'Duplicate key name \'groupID_tableName\'', 'guest', '/citrus/app/index.php'),
('2021-08-15 07:39:46', 'ALTER TABLE `membership_userpermissions` ADD UNIQUE INDEX `memberID_tableName` (`memberID`, `tableName`)', '0.00', 'Duplicate key name \'memberID_tableName\'', 'guest', '/citrus/app/index.php'),
('2021-08-15 07:39:46', 'INSERT INTO `membership_users` SET \r\n			`memberID`=\'admin\', \r\n			`passMD5`=\'$2y$10$2Mx6O8/tNfzm.hsjnX3b6eEqAyRFDta7w6mOIwNHXtwzzarY/IuYq\', \r\n			`email`=\'admin@admin.com\', \r\n			`signUpDate`=\'2021-08-15\', \r\n			`groupID`=\'2\', \r\n			`isBanned`=0, \r\n			`isApproved`=1, \r\n			`comments`=\'Admin member created automatically on 2021-08-15\'', '0.00', 'Duplicate entry \'admin\' for key \'PRIMARY\'', 'guest', '/citrus/app/index.php'),
('2021-08-15 11:02:09', 'ALTER TABLE `membership_groups` ADD UNIQUE INDEX `name` (`name`)', '0.00', 'Duplicate key name \'name\'', 'guest', '/citrus/app/index.php?loginFailed=1'),
('2021-08-15 11:02:09', 'ALTER TABLE `membership_groups` ADD COLUMN `allowCSVImport` TINYINT NOT NULL DEFAULT \'0\'', '0.00', 'Duplicate column name \'allowCSVImport\'', 'guest', '/citrus/app/index.php?loginFailed=1'),
('2021-08-15 11:02:09', 'ALTER TABLE `membership_users` ADD COLUMN `pass_reset_key` VARCHAR(100)', '0.00', 'Duplicate column name \'pass_reset_key\'', 'guest', '/citrus/app/index.php?loginFailed=1'),
('2021-08-15 11:02:09', 'ALTER TABLE `membership_users` ADD COLUMN `pass_reset_expiry` INT UNSIGNED', '0.00', 'Duplicate column name \'pass_reset_expiry\'', 'guest', '/citrus/app/index.php?loginFailed=1'),
('2021-08-15 11:02:09', 'ALTER TABLE `membership_users` ADD INDEX `groupID` (`groupID`)', '0.00', 'Duplicate key name \'groupID\'', 'guest', '/citrus/app/index.php?loginFailed=1'),
('2021-08-15 11:02:09', 'ALTER TABLE `membership_users` ADD COLUMN `flags` TEXT', '0.00', 'Duplicate column name \'flags\'', 'guest', '/citrus/app/index.php?loginFailed=1'),
('2021-08-15 11:02:09', 'ALTER TABLE `membership_users` ADD COLUMN `allowCSVImport` TINYINT NOT NULL DEFAULT \'0\'', '0.00', 'Duplicate column name \'allowCSVImport\'', 'guest', '/citrus/app/index.php?loginFailed=1'),
('2021-08-15 11:02:09', 'ALTER TABLE `membership_userrecords` ADD UNIQUE INDEX `tableName_pkValue` (`tableName`, `pkValue`(150))', '0.00', 'Duplicate key name \'tableName_pkValue\'', 'guest', '/citrus/app/index.php?loginFailed=1'),
('2021-08-15 11:02:09', 'ALTER TABLE `membership_userrecords` ADD INDEX `pkValue` (`pkValue`)', '0.00', 'Duplicate key name \'pkValue\'', 'guest', '/citrus/app/index.php?loginFailed=1'),
('2021-08-15 11:02:09', 'ALTER TABLE `membership_userrecords` ADD INDEX `tableName` (`tableName`)', '0.00', 'Duplicate key name \'tableName\'', 'guest', '/citrus/app/index.php?loginFailed=1'),
('2021-08-15 11:02:09', 'ALTER TABLE `membership_userrecords` ADD INDEX `memberID` (`memberID`)', '0.00', 'Duplicate key name \'memberID\'', 'guest', '/citrus/app/index.php?loginFailed=1'),
('2021-08-15 11:02:09', 'ALTER TABLE `membership_userrecords` ADD INDEX `groupID` (`groupID`)', '0.00', 'Duplicate key name \'groupID\'', 'guest', '/citrus/app/index.php?loginFailed=1'),
('2021-08-15 11:02:09', 'ALTER TABLE `membership_grouppermissions` ADD UNIQUE INDEX `groupID_tableName` (`groupID`, `tableName`)', '0.00', 'Duplicate key name \'groupID_tableName\'', 'guest', '/citrus/app/index.php?loginFailed=1'),
('2021-08-15 11:02:09', 'ALTER TABLE `membership_userpermissions` ADD UNIQUE INDEX `memberID_tableName` (`memberID`, `tableName`)', '0.00', 'Duplicate key name \'memberID_tableName\'', 'guest', '/citrus/app/index.php?loginFailed=1'),
('2021-08-15 11:02:09', 'INSERT INTO `membership_users` SET \r\n			`memberID`=\'admin\', \r\n			`passMD5`=\'$2y$10$2Mx6O8/tNfzm.hsjnX3b6eEqAyRFDta7w6mOIwNHXtwzzarY/IuYq\', \r\n			`email`=\'admin@admin.com\', \r\n			`signUpDate`=\'2021-08-15\', \r\n			`groupID`=\'2\', \r\n			`isBanned`=0, \r\n			`isApproved`=1, \r\n			`comments`=\'Admin member created automatically on 2021-08-15\'', '0.00', 'Duplicate entry \'admin\' for key \'PRIMARY\'', 'guest', '/citrus/app/index.php?loginFailed=1'),
('2021-08-15 11:08:20', 'SELECT\n				`applicants_and_tenants`.`status` AS \'label\', COUNT(1) AS \'value\'\n			FROM \n				 \n				 AND (1=1)\n			GROUP BY label\n			ORDER BY value desc', '0.00', 'You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near \'AND (1=1)\n			GROUP BY label\n			ORDER BY value desc\' at line 5', 'guest', '/citrus/app/hooks/summary-reports-applicants_and_tenants-0.php'),
('2021-08-31 16:29:35', 'ALTER TABLE `membership_groups` ADD UNIQUE INDEX `name` (`name`)', '0.00', 'Duplicate key name \'name\'', 'guest', '/citrus/app/index.php'),
('2021-08-31 16:29:35', 'ALTER TABLE `membership_groups` ADD COLUMN `allowCSVImport` TINYINT NOT NULL DEFAULT \'0\'', '0.00', 'Duplicate column name \'allowCSVImport\'', 'guest', '/citrus/app/index.php'),
('2021-08-31 16:29:35', 'ALTER TABLE `membership_users` ADD COLUMN `pass_reset_key` VARCHAR(100)', '0.00', 'Duplicate column name \'pass_reset_key\'', 'guest', '/citrus/app/index.php'),
('2021-08-31 16:29:35', 'ALTER TABLE `membership_users` ADD COLUMN `pass_reset_expiry` INT UNSIGNED', '0.00', 'Duplicate column name \'pass_reset_expiry\'', 'guest', '/citrus/app/index.php'),
('2021-08-31 16:29:35', 'ALTER TABLE `membership_users` ADD INDEX `groupID` (`groupID`)', '0.00', 'Duplicate key name \'groupID\'', 'guest', '/citrus/app/index.php'),
('2021-08-31 16:29:35', 'ALTER TABLE `membership_users` ADD COLUMN `flags` TEXT', '0.00', 'Duplicate column name \'flags\'', 'guest', '/citrus/app/index.php'),
('2021-08-31 16:29:35', 'ALTER TABLE `membership_users` ADD COLUMN `allowCSVImport` TINYINT NOT NULL DEFAULT \'0\'', '0.00', 'Duplicate column name \'allowCSVImport\'', 'guest', '/citrus/app/index.php'),
('2021-08-31 16:29:35', 'ALTER TABLE `membership_userrecords` ADD UNIQUE INDEX `tableName_pkValue` (`tableName`, `pkValue`(150))', '0.00', 'Duplicate key name \'tableName_pkValue\'', 'guest', '/citrus/app/index.php'),
('2021-08-31 16:29:35', 'ALTER TABLE `membership_userrecords` ADD INDEX `pkValue` (`pkValue`)', '0.00', 'Duplicate key name \'pkValue\'', 'guest', '/citrus/app/index.php'),
('2021-08-31 16:29:35', 'ALTER TABLE `membership_userrecords` ADD INDEX `tableName` (`tableName`)', '0.00', 'Duplicate key name \'tableName\'', 'guest', '/citrus/app/index.php'),
('2021-08-31 16:29:35', 'ALTER TABLE `membership_userrecords` ADD INDEX `memberID` (`memberID`)', '0.00', 'Duplicate key name \'memberID\'', 'guest', '/citrus/app/index.php'),
('2021-08-31 16:29:35', 'ALTER TABLE `membership_userrecords` ADD INDEX `groupID` (`groupID`)', '0.00', 'Duplicate key name \'groupID\'', 'guest', '/citrus/app/index.php'),
('2021-08-31 16:29:35', 'ALTER TABLE `membership_grouppermissions` ADD UNIQUE INDEX `groupID_tableName` (`groupID`, `tableName`)', '0.00', 'Duplicate key name \'groupID_tableName\'', 'guest', '/citrus/app/index.php'),
('2021-08-31 16:29:35', 'ALTER TABLE `membership_userpermissions` ADD UNIQUE INDEX `memberID_tableName` (`memberID`, `tableName`)', '0.00', 'Duplicate key name \'memberID_tableName\'', 'guest', '/citrus/app/index.php'),
('2021-08-31 16:29:35', 'INSERT INTO `membership_users` SET \r\n			`memberID`=\'admin\', \r\n			`passMD5`=\'$2y$10$2Mx6O8/tNfzm.hsjnX3b6eEqAyRFDta7w6mOIwNHXtwzzarY/IuYq\', \r\n			`email`=\'admin@admin.com\', \r\n			`signUpDate`=\'2021-08-31\', \r\n			`groupID`=\'2\', \r\n			`isBanned`=0, \r\n			`isApproved`=1, \r\n			`comments`=\'Admin member created automatically on 2021-08-31\'', '0.00', 'Duplicate entry \'admin\' for key \'PRIMARY\'', 'guest', '/citrus/app/index.php');
...
('djrmsoo1s519ogi8hue89l2viokqnab3', '::1', 1629013314, 0x5f5f63695f6c6173745f726567656e65726174657c693a313632393031333331323b),
('nurosp1a6e8140flg3g87dmaekujshv2', '::1', 1629029386, 0x5f5f63695f6c6173745f726567656e65726174657c693a313632393032393338363b),
('10rrt9u0ee9ft107herlc18hbsleamj7', '::1', 1629029386, 0x5f5f63695f6c6173745f726567656e65726174657c693a313632393032393338363b),
('7ruiea3rieros87ji66sd6a5bhm4o255', '::1', 1630326481, 0x5f5f63695f6c6173745f726567656e65726174657c693a313633303332363438313b),
('5f074sljg1ibnov5uonplceic2c3mlir', '::1', 1630328251, 0x5f5f63695f6c6173745f726567656e65726174657c693a313633303332383235313b),
('tr0v6j6iv7qk823q6opove5gkdslgftv', '::1', 1630328559, 0x5f5f63695f6c6173745f726567656e65726174657c693a313633303332383535393b),
('6pneo5smk6inlohcd2aqgaoaliuja881', '::1', 1630328872, 0x5f5f63695f6c6173745f726567656e65726174657c693a313633303332383837323b),
('9utqaubn9hunn1aai1fu0oj3gd7tln0i', '::1', 1630329183, 0x5f5f63695f6c6173745f726567656e65726174657c693a313633303332393138333b),
('3o0p5432qo14fv4334s8mv6gnfh7knh9', '::1', 1630329202, 0x5f5f63695f6c6173745f726567656e65726174657c693a313633303332393138333b),
('cogl97rle1q9jg1aatllhdbhu0vtoj95', '::1', 1630418699, 0x5f5f63695f6c6173745f726567656e65726174657c693a313633303431383639393b),
('k02hc0b1bqg8lo8emc30k3g029160t3j', '::1', 1630421962, 0x5f5f63695f6c6173745f726567656e65726174657c693a313633303432313936323b),
('o788amqe2q0im7fo6ic2bhnklmr1uvmg', '::1', 1630425394, 0x5f5f63695f6c6173745f726567656e65726174657c693a313633303432353339343b),
('s9mgajhtg3pmgt1pper1sp65ft2j8uv7', '::1', 1630425394, 0x5f5f63695f6c6173745f726567656e65726174657c693a313633303432353339343b),
('73a67tn44bofv57bhk4006josb4sact7', '::1', 1630428195, 0x5f5f63695f6c6173745f726567656e65726174657c693a313633303432383139353b);
...
('admin', '$2y$10$S6nFm73KdEWgf.X7ZR2orOQL3b24eArzLcjodOQ9pMcKlc/qOn5Ni', 'admin@admin.com', '2021-07-08', 2, 0, 1, NULL, NULL, NULL, NULL, 'Admin member created automatically on 2021-07-08', NULL, NULL, 0, NULL),
...
INSERT INTO `service_categories` (`id`, `name`, `created_on`, `modified_on`) VALUES
(1, 'Ac Repairing', NULL, '2021-08-15 18:29:35');

-- --------------------------------------------------------

--
-- Table structure for table `service_owners`
--
...
--
-- Dumping data for table `service_owners`
--

INSERT INTO `service_owners` (`id`, `first_name`, `last_name`, `company_name`, `date_of_birth`, `primary_email`, `alternate_email`, `phone`, `country`, `street`, `city`, `state`, `zip`, `comments`) VALUES
(1, 'Islam', 'Shaikh', 'Precloud Technologies', '1991-01-29', 'islamjshaikh@gmail.com', NULL, '+919503460604', 'India', 'M403 Mega Center', 'Pune', 'MH', '411042', '<br>');
...
--
-- Indexes for table `service_owners`
--
...
--
ALTER TABLE `membership_grouppermissions`
  MODIFY `permissionID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=101;

--
-- AUTO_INCREMENT for table `membership_groups`
--
ALTER TABLE `membership_groups`
  MODIFY `groupID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
-- AUTO_INCREMENT for table `service_owners`
--
ALTER TABLE `service_owners`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
